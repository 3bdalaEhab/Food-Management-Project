        ...
        <div className="space-y-12 pb-24">
            ...
            >
                ...
                <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-8">
                    <div className="space-y-6">
                        <div className="flex items-center gap-3">
                            <div className="px-4 py-1.5 rounded-full bg-white/5 border border-white/10 flex items-center gap-2">
                                ...
                                <span className="text-[10px] font-black uppercase tracking-widest text-white/60">Fleet Command</span>
                            </div>
                    ...
                    <div className="flex bg-white/5 border border-white/10 p-6 rounded-[2.5rem] backdrop-blur-3xl">
                        <div className="space-y-1">
                            <p className="text-[10px] font-black text-white/40 uppercase tracking-widest">Active Fleet Size</p>
                            <p className="text-4xl font-black text-white italic">{usersData?.totalNumberOfRecords || 0} <span className="text-primary-500 text-sm">AGENTS</span></p>
                        </div>
                    </div>
                </div>
            </motion.div>
                            ...
                            >
                                ...
                                <div className="relative z-10 flex items-center gap-8">
                                    <div className="relative">
                                        <div className="w-20 h-20 rounded-[2rem] bg-neutral-900 overflow-hidden flex items-center justify-center border-4 border-white dark:border-neutral-800 shadow-2xl group-hover:scale-110 transition-transform duration-700">
                                            {user.imagePath ? (
                                                <img src={user.imagePath} alt={user.userName} className="w-full h-full object-cover" />
                                            ) : (
                                                <ChefHat className="text-white/20" size={36} />
                                            )}
                                        </div>
                                        <div className="absolute -bottom-1 -right-1 w-8 h-8 rounded-xl bg-primary-500 flex items-center justify-center text-white shadow-[0_4px_15px_rgba(255,107,38,0.4)] ring-4 ring-white dark:ring-neutral-900 group-hover:rotate-12 transition-transform">
                                            <ShieldCheck size={16} />
                                        </div>
                                    </div>
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <div className="flex flex-wrap items-center gap-6">
                                            <span className="flex items-center gap-2 bg-neutral-900 text-white px-4 py-1.5 rounded-full text-[10px] font-black uppercase tracking-widest shadow-xl">
                                ...
                                <div className="relative z-10 grid grid-cols-1 sm:grid-cols-2 lg:flex items-center gap-8 lg:gap-14">
                                    ...
                                    <div className="flex items-center gap-4 ml-auto lg:ml-0 lg:pl-10">
                                        ...
                                        <div className="w-14 h-14 rounded-2xl bg-neutral-50 dark:bg-white/5 flex items-center justify-center text-neutral-300">
