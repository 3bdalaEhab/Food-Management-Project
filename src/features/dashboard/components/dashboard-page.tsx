        ...
        <div className="space-y-10" role="main">
            ...
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-10">
                ...
                >
                    ...
                    <div className="glass-card rounded-[3.5rem] overflow-hidden border border-[var(--border)] bg-[var(--sidebar-background)] p-10 shadow-xl">
                        <div className="space-y-6">
                            {[
                ...
                >
                    ...
                    <div className="glass-card rounded-[3rem] border border-[var(--border)] bg-[var(--sidebar-background)]/95 p-8 space-y-4">
