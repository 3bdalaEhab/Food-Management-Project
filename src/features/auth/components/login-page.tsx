                    ...
                    <div className="flex flex-col items-center">
                        ...
                        <div className="flex flex-col items-center text-center space-y-6 mb-12">
                            <motion.div
                                ...
                                className="w-24 h-24 bg-gradient-to-br from-neutral-900 to-neutral-800 rounded-[2.5rem] flex items-center justify-center shadow-2xl relative group overflow-hidden border border-white/10"
                            >
                                <div className="absolute inset-0 bg-primary-500 opacity-0 group-hover:opacity-100 transition-opacity duration-500" />
                                <ChefHat className="w-12 h-12 text-white relative z-10 drop-shadow-lg" />
                            </motion.div>
