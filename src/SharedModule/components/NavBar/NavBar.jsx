...
export default function NavBar() {
  ...
  const { logout: logoutFromContext } = useContext(tokenContext);
        ...
        <div className="container-fluid">
          <form className="col-sm-6 col-12 navbar-brand d-none d-md-block">
            <div className="input-group">
              <input
                className="search form-control rounded-pill bg-white h-25 border-0"
                type="search"
          ...
          <Link className="navbar-brand d-md-none">
            <div>
              <img className="w-100 logo-navbar" src={icon} alt="Logo" />
            </div>
          </Link>
          <button
            className="navbar-toggler mx-sm-0"
            type="button"
          ...
          <div className="collapse navbar-collapse mt-lg-0 mt-3" id="navbarSupportedContent">
            ...
            <ul className="d-none gap-4 navbar-nav d-md-flex col-lg-6 col-xl-3 gap-3 align-items-center justify-content-around ms-auto mb-2 mb-lg-0">
              ...
              <div className="d-flex flex-column flex-lg-row align-items-center gap-3">
                <li className="order-lg-0 order-1 nav-item dropdown">
                  <a
                    className="nav-link dropdown-toggle mx-auto text-center"
                    role="button"
                  ...
                  <ul className="dropdown-menu">
                    <li className="text-center">
                      <Link className="fw-medium logoutButton" onClick={handleLogout}>
            ...
            <ul className="navbar-nav ms-auto mb-2 mb-lg-0 mx-auto text-center d-md-none">
              ...
              <li className="nav-item">
                <Link to={"/dashboard/RecipesList"} className="nav-link active" aria-current="page">
                  Recipes
                </Link>
              </li>
              {jwtDecode?.userGroup === "SuperAdmin" ? (
                <>
                  <li className="nav-item">
                    <Link to={"/dashboard/UserList"} className="nav-link active" aria-current="page">
                      Users
                    </Link>
                  </li>
                  <li className="nav-item">
                    <Link to={"/dashboard/CategoriesList"} className="nav-link active" aria-current="page">
                      Categories
                    </Link>
                  </li>
                </>
                ...
                <li className="nav-item">
                  <Link to={"/dashboard/FavoriteList"} className="nav-link active" aria-current="page">
                    Favorites
                  </Link>
                </li>
              )}
              ...
              <li className="nav-item dropdown">
                ...
                <ul className="dropdown-menu text-center p-1 text-center mx-auto">
                  <li className="my-2">
                    <Link onClick={handleShow} className="dropdown text-success">
                      Change Password
                    </Link>
                  </li>
                  <li>
                    <Link onClick={handleLogout} className="dropdown-item text-danger fw-bold">
                      Logout <i className="ms-1 fa-solid fa-right-long"></i>
                    </Link>
                  </li>
                </ul>
              </li>
